...
class BookmarkedLecturesFragment : BaseFragment() {
    @Inject
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory)[BookmarkedLecturesViewModel::class.java]
        setupRecyclerViews()
    }

    private fun setupRecyclerViews() {
        list.layoutManager = LinearLayoutManager(activity)
        list.adapter = BookmarkedLectureAdapter(this, viewModel.bookmarkedLectures, api) { lecture ->
            activity?.let {
